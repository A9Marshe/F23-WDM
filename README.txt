...
We orchestrated all commands in a chain of code blocks with relevant comments and informative text.

We also exported all of our findings to tabular forms and visual forms (charts) that can be inspected in the attached report.html file
